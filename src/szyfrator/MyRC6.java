...
public class MyRC6 {
    ...
    public MyRC6() {
//        String jawny = "ala ma kota ala ma kota ala ma kota ala ma kota ala ma kota";
//        String sesyjny = "230814868941015003431442825791974801140";
//        
//        byte[] jawnyByteVer = jawny.getBytes();
//        byte[] sesByteVer = sesyjny.getBytes();
////        System.out.println("ssss " + sesByteVer.length);
//        generateSubkeys(sesByteVer);
//        
//        byte[] tajny = encryptBloc(jawnyByteVer);
//        String tajnyStrVer = Arrays.toString(tajny);
//        System.out.println("Tajny: " + tajnyStrVer);
...
//        System.out.println("1: " + key.length);
        key = paddingKey(key);
//        System.out.println("2: " + key.length);
        ...
        for (j = 0; j < data.length + lenght; j++) {
            if (j > 0 && j % 16 == 0) {
                ...
                System.arraycopy(bloc, 0, tmp, j - 16, bloc.length);
            }
